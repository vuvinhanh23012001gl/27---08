...
const canvas_img_show_oke = document.getElementById("canvas-img");
const ctx_oke = canvas_img_show_oke.getContext("2d");
...
const table_write_data = document.getElementById("table");
const part_table_log =  document.getElementById("part-table-log");
...
const btn_erase = document.getElementById("btn-erase");
const btn_check = document.getElementById("btn-check");

const select_min = document.getElementById("btn-select-min");
const select_max = document.getElementById("btn-select-max");

const btn_accept_and_send =  document.getElementById("btn-accept-and-send-server");     // Nút nhấn chấp nhận kết nối
const api_training = document.getElementById("api-training");
// ==========================
// 2. State Variables
// ==========================
